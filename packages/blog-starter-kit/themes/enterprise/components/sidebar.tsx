		...
		<DialogPrimitive.Root open>
			<DialogPrimitive.Portal>
				...
				<DialogPrimitive.Content
					...
					} fixed bottom-0 left-0 top-0 z-50 flex w-80 transform flex-col bg-white shadow-2xl duration-300 ease-out dark:border-neutral-800 dark:bg-darkBackground`}
				>
